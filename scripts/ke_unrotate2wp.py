...
# Unrotate2wp 1.0 Kjell Emanuelsson 2017
#
# Aligns element selection straightens/unrotates with position and rotation from aligned workplane.
# 
# Usage :   1. Fit Workplane to where you want the 'bottom' oriented
...
#		 + In a few cases Y axis goes inverted : prob wont fix ;>
#		 (Easy enough to adjust as long as you have the proper rotation.)
