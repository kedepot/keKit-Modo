...
# Itemize 1.1 Kjell Emanuelsson 2017-21
#  1.1 - Python3 fixes
...
# 			3. The FIRST vertex selection = CENTER offset position
# 			(where your center POSITION will be) instead of workplane center.
#			   (Verts will thus also be checked in EDGE/POLY mode,
#			   so keep vert selections empty unless you want an offset center.)
#
...
#		 + In a few cases Y axis goes inverted :
#		 prob wont fix ;>  (Easy enough to adjust as long as you have the proper rotation.)
